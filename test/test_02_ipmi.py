...
class TestIpmi:
    ...
    @pytest.mark.parametrize("platform_name, zone, level, error", [
        ('X11SCH-F', 0, 0,        'Ipmi.set_fan_level() 1'),
        ('X11SCH-F', 0, 50,       'Ipmi.set_fan_level() 2'),
        ('X11SCH-F', 0, 100,      'Ipmi.set_fan_level() 3'),
        ('X11SCH-F', 1, 0,        'Ipmi.set_fan_level() 4'),
        ('X11SCH-F', 1, 50,       'Ipmi.set_fan_level() 5'),
        ('X11SCH-F', 1, 100,      'Ipmi.set_fan_level() 6'),
        ('X10QBi', 16, 0,        'Ipmi.set_fan_level() 7'),
        ('X10QBi', 16, 50,       'Ipmi.set_fan_level() 8'),
        ('X10QBi', 17, 100,      'Ipmi.set_fan_level() 9'),
        ('X10QBi', 18, 0,        'Ipmi.set_fan_level() 10'),
        ('X10QBi', 19, 50,       'Ipmi.set_fan_level() 11'),
        ('X10QBi', 19, 100,      'Ipmi.set_fan_level() 12'),
    ])
    ...
    @pytest.mark.parametrize("platform_name, zones, level, error", [
        ('X11SCH-F', [0],              0,      'Ipmi.set_multiple_fan_levels() 1'),
        ('X11SCH-F', [0, 1],           50,     'Ipmi.set_multiple_fan_levels() 2'),
        ('X11SCH-F', [0, 1, 2],        100,    'Ipmi.set_multiple_fan_levels() 3'),
        ('X10QBi',   [16],             0,      'Ipmi.set_multiple_fan_levels() 4'),
        ('X10QBi',   [16, 17],         50,     'Ipmi.set_multiple_fan_levels() 5'),
        ('X10QBi',   [16, 17, 18, 19], 100,    'Ipmi.set_multiple_fan_levels() 6'),
    ])
