...
- New smoke test [`run_test_control_function.sh`](https://github.com/petersulyok/smfc/blob/main/test/run_test_control_function.sh) exercises the advanced multi-segment user-defined `control_function=` parameter.
